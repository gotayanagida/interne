...
Color.create(name:"ブルー",main:'#0396FF',bg:'#ABDCFF',grad_1:'#0396FF',grad_2:'#ABDCFF')
Color.create(name:"イエロー",main:'#F8D800',bg:'#FDEB71',grad_1:'#F8D800',grad_2:'#FDEB71')
Color.create(name:"レッド",main:'#EA5455',bg:'#FEB692',grad_1:'#EA5455',grad_2:'#FEB692')
