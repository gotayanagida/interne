...
if Rails.env.production?
  ...
  user.save!
  user = User.new(name:"柳田豪太（社員）",password:"interne",department:"マーケティング本部",position:"部長",email:"gota.yanagida@digital-k.co.jp",gender:0,birthday:"1980/1/1",profile_photo_url:"pf_gota.png",employment_status:0,home_photo_url:"home.png")
  user.save!
  user = User.new(name:"佐藤翔野（社員）",password:"interne",department:"マーケティング本部",position:"部長",email:"shoya.sato@digital-k.co.jp",gender:0,birthday:"1980/1/1",profile_photo_url:"pf_shoya.png",employment_status:0,home_photo_url:"home.png")
  user.save!
  ...
  Attendance.create(user_id:5,company_id:1,work_started_at:"2017/10/21 8:56:47",work_stopped_at:"2017/10/21 18:07:13",break_started_at:"2017/10/21 12:09:32",break_stopped_at:"2017/10/21 13:07:28",num_of_edit:0)
  Attendance.create(user_id:6,company_id:1,work_started_at:"2017/10/21 8:56:47",work_stopped_at:"2017/10/21 18:07:13",break_started_at:"2017/10/21 12:09:32",break_stopped_at:"2017/10/21 13:07:28",num_of_edit:0)
  Notice.create(body:"明日（11月9日）は9時〜18時で出勤予定です。")
  Notice.create(body:"あなたの11月9日のタスクを、社員太郎さんが追加しました。")
  Notice.create(body:"向こう１週間のシフトが入っておりません...すぐにシフト入力しましょう。")
  Notice.create(body:"本日（11月8日）の業務お疲れ様でした！次回は11月9日9時〜18時で出社予定です。")
  Notice.create(body:"鈴木二郎さんが11月6日出社の日報を追加しました。")
  Notice.create(body:"明日（11月9日）インターン出社予定は、田中一郎さんが9時〜18時、と鈴木二郎さんが13時〜18時です。")
  Notice.create(body:"山田太郎さんの向こう１週間のシフトが入っておりません。本人に確認してみましょう。")
  ...
  Todo.create(body:"11月7日出社の日報を提出しましょう。")
  Todo.create(body:"向こう１週間のシフトが入っておりません...すぐにシフト入力しましょう。")
  Todo.create(body:"鈴木二郎さんが11月6日出社の日報を追加しました。確認してスタンプを押しましょう。")
  Todo.create(body:"田中一郎さんが目標「一人前のエンジニアになる」を追加しました。確認してスタンプを押しましょう。")
  ReportTodo.create(report_id:1,todo_id:4)
